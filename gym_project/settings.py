...
SECRET_KEY = os.environ.get('DJANGO_SECRET_KEY', 'django-insecure-zoen5nmlc5ns@2^em+(l3k+^954@y=op8#g9a9q0q6i@&u)^aq')
...
# Добавляем Whitenoise middleware только если он установлен (для продакшена)
try:
